...
public class SchInfoActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InfoPhone = (ImageView) findViewById(R.id.schInfo_phone);
        ...
        InfoEmail =(ImageView) findViewById(R.id.schInfo_email);
        InfoLocation = (ImageView) findViewById(R.id.schInfo_location);
        ...
        mapView = findViewById(R.id.schmapView);
        mapView.onCreate(mapViewBundle);
        mapView.getMapAsync(SchInfoActivity.this);



        lag = intent.getDoubleExtra("school_lag",0);
        lat =intent.getDoubleExtra("school_lat",0);
        ...
        InfoLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (lat != 0 && lag != 0) {
                    ...
                    Toast.makeText(SchInfoActivity.this, "لايوجد موقع مضاف", Toast.LENGTH_SHORT).show();
                }
            }
        });
       ...
       // InfoEmail.setText(intent.getStringExtra("school_email"));
        ...
        InfoPhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!intent.getStringExtra("school_phone").isEmpty())
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(SchInfoActivity.this);

                    builder.setTitle("الإتصال بالجهة");

                    builder.setMessage("هل تريد الإتصال ب:" + intent.getStringExtra("school_name") + "\n" + intent.getStringExtra("school_phone"));
                    builder.setPositiveButton("نعم", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Uri number = Uri.parse("tel:" + intent.getStringExtra("school_phone"));
                ...
                {
                    Toast.makeText(SchInfoActivity.this, "لايوجد رقم مضاف", Toast.LENGTH_LONG).show();
        ...
        InfoEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (! intent.getStringExtra("school_email").isEmpty()) {

                    Intent emailIntent = new Intent(Intent.ACTION_SENDTO);
                    emailIntent.setData(Uri.parse("mailto:" + intent.getStringExtra("school_email")));
                    try {
                    ...
                    Toast.makeText(SchInfoActivity.this, "لايوجد ايميل مضاف", Toast.LENGTH_LONG).show();
